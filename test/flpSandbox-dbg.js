		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bill Of Material App",
									"targetURL": "#BillOfMaterialApp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BillOfMaterialApp-display": {
								"semanticObject": "BillOfMaterialApp",
								"action": "display",
								"description": "Bill Of Material App",
								"title": "Bill Of Material App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bom.sap.com.zbomapp",
									"url": sap.ui.require.toUrl("com/bom/sap/com/zbomapp")
								}
							}
						}
					}
