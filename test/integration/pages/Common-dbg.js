sap.ui.define([
	...
	return Opa5.extend("com.bom.sap.com.zbomapp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/bom/sap/com/zbomapp/localService/mockserver"], function (mockserver) {
