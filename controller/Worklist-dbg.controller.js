...
///this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[3].property[1].name
			...
			this.oDataInitial = {
				...
				Items: [{
					...
					text:this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[3].extensions[1].value
				}, {
					...
					text:this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[41].extensions[0].value
				}, {
