...
], function (BaseController, JSONModel, formatter, Filter, FilterOperator, Token, Export, ExportTypeCSV, MessageBox, MultiInput) {
	"use strict";
	...
	return BaseController.extend("com.bom.sap.com.zbomapp.controller.Worklist", {
		...
		onInit: function () {
			...
			this.oDataInitial = {
				// Static data
				Items: [{
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[1].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[1].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[2].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[2].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[4].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[4].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[6].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[6].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[7].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[7].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[8].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[8].extensions[0].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[10].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[10].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[11].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[11].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[13].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[13].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[20].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[20].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[21].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[21].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[22].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[22].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[23].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[23].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[24].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[24].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[25].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[25].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[57].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[57].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[58].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[58].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[60].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[60].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[61].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[61].extensions[1].value
				}, {
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[79].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[79].extensions[1].value
				},{
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[3].name,
					text: "Header Material"
				},{
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[26].name,
					text: "Level"
				},{
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[62].name,
					text: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[3].property[8].extensions[1].value
				},{
					columnKey: this.getModel("oRefModel").getServiceMetadata().dataServices.schema[0].entityType[0].property[41].name,
