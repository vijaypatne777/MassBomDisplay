		...
		testExpand:function(oEvent){
			var url = "/OPENSAP/sap/opu/odata/sap/API_BILL_OF_MATERIAL_SRV;v=0002";
						...
						//oModel.setDefaultBindingMode("TwoWay");
							...
							oFilter[0] = new sap.ui.model.Filter("Material", sap.ui.model.FilterOperator.EQ,"2301139");
				...
				oModel.read("/MaterialBOM", { // Get all valid material
					...
					success: function (oData, response) {
						...
						var 	oFilterTest = [];
							...
							// All Parameters -  End
							var urlParameter = "/MaterialBOMItem/?$expand=to_BillOfMaterial"

							oModel.read(urlParameter, {
							filters: oFilter,
								urlParameters: {
									//"$expand": "to_BillOfMaterial",
									//"$select": "Material"
